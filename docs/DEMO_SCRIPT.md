...
This script is for a public demo conversation, investor preview, or GitHub README walkthrough.
...
Do not show private queue records, telemetry, screenshots with sensitive info, credentials, raw coursework, private project files, unpublished adult content, medical/legal/family material, or local signing material.
