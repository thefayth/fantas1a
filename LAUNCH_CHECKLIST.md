...
- [x] Public export folder exists: _github_public_export
- [x] README exists
- [x] Hero image exists
- [x] GitHub banner exists
- [x] Social card exists
...
- [x] Push refreshed export to https://github.com/thefayth/fantas1a
